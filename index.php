...
<html>
<head>
<title>HALO ORANG ORANG UHUYY</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h4><a href="index.php"> Toko Jual kulkas</a></h4>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/ast-914830.png" alt="" />
			</li>
			<li>
				<img src="images/ast-1429468.jpg.pub.crop.pc.thumb.640.1200.jpg" alt="" />
			</li>
			
			<li>
				<img src="images/Digital_1600x600.jpg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
