...
<?php 
	...
	if(isset($_POST['addcategory']))
	{
        ...
        $namakategori = $_POST['namakategori'];
        $q2 = mysqli_query($conn, "DELETE from kategori where namakategori='$namakategori' ");
        if($q2){
            echo "Berhasil Hapus";
        } else {
            echo "Gagal Hapus";
...
<head>
    ...
    <title>Kelola Kategori - Toko Jual kulkas</title>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td>
                                                        <input type="submit" class="from-control" value="hapus" name="hapus">
                                                    </td>
												</tr>		
